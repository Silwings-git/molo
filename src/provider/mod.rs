...
pub enum StreamEvent {
    ...
    /// The full text of the model's reasoning; the vendor delivers it in
    /// fragments during the stream, and the Provider emits it at the end of
    /// the turn after aggregating.
    ///
