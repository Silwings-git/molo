...
#[cfg(feature = "harness")]
use crate::effect::{DisplayFormat, DisplayOutput};
use crate::effect::{EffectKind, EffectRequest, RiskLevel};
#[cfg(feature = "harness")]
use crate::harness::{
...
impl McpToolDescriptor {
    /// Source metadata suitable for [`ToolRegistry`](crate::tool::ToolRegistry)
...
impl McpClient {
    ...
    /// `effect_tools` with `mcp + harness` for
...
mod tests {
    ...
    async fn effect_executor_maps_success_and_tool_error() {
        ...
        let policy = ExecutionPolicy::new(SandboxPolicy::ReadOnly, NetworkPolicy::Deny)
