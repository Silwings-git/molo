...
use molo::{
    ...
    CommandExecutorIdentity, CommandOutput, CommandRequest, ExecutionPolicy, RunContext,
};
...
impl CommandExecutor for IsolatedCommandExecutor {
    fn capabilities(&self) -> CommandExecutorCapabilities {
        CommandExecutorCapabilities::enforced(
            CommandExecutorIdentity::new(
                "isolated-command-executor",
                CommandExecutorBackend::HostProvided,
            )
            .with_version("1.0.0"),
        )
    }
